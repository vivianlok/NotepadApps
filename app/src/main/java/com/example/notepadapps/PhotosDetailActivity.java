        ...
        postTextView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
             ...
             if (TextUtils.isEmpty(commentEditText.getText().toString())){
                 ...
                 Toast.makeText(PhotosDetailActivity.this, "Please enter comment", Toast.LENGTH_SHORT).show();
             } else {
                 ...
                 photoAlbumReference
                         ...
                         .addOnSuccessListener(new OnSuccessListener<Void>() {
                             ...
                             public void onSuccess(Void aVoid) {
                                 ...
                                 Toast.makeText(PhotosDetailActivity.this, "Comments successsfully added!", Toast.LENGTH_SHORT).show();
                             }
                         });
                    ...
                    public void onChildAdded(@NonNull DataSnapshot dataSnapshot, @Nullable String s) {
                        ...
                        if (dataSnapshot.exists()) {
                          ...
                          commentsAdapter  = new CommentsAdapter(
                                    PhotosDetailActivity.this, commentsFirebaseItemsList);
